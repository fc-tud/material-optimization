...
class NGOptimizer(BaseOptimizer):
    ...
    def define_optimizer(self):
        optimizer_mapping = {
            ...
            'ScrHaltonSearch': ng.optimizers.ScrHaltonSearch
    ...
    def save_results(self):
        ...
        metadata_dict = self.use_case_metadata(metadata_dict)
        ...
        with open(os.path.join(self.output_dir, 'results.txt'), 'w') as f:
            with redirect_stdout(f):
                ...
                print(f"Model output: {metadata_dict['model_output']}")
    ...
    def use_case_metadata(self, metadata_dict):
